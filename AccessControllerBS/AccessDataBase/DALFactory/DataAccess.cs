...
namespace KryptonAccessController.AccessDataBase.DALFactory
{
	...
	public sealed class DataAccess//<t>
	{
        ...
        private static readonly string AssembleName = "AccessControllerBS";
		/// <summary>
		/// 创建对象或从缓存获取
		/// </summary>
		public static object CreateObject(string AssemblyPath,string ClassNamespace)
		{
            DbHelperSQL.connectionString = ConfigurationManager.ConnectionStrings["AccessDataBaseConnectionString"].ToString();
