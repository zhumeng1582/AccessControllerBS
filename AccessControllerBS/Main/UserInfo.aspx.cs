...
namespace AccessControllerBS.Main
{
    ...
    {
        KryptonAccessController.AccessDataBase.BLL.UserInfo bllUserInfo = new KryptonAccessController.AccessDataBase.BLL.UserInfo();
        ...
        protected void GridViewUser_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            //重新绑定
            theGrid.DataSource = bllUserInfo.GetAllList().Tables[0];
            theGrid.DataBind();
        }
    }
}